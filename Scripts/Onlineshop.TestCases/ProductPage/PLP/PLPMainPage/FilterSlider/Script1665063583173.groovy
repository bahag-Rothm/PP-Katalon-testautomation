...
boolean result = CustomKeywords.'onlineshop.Keywords.ProductListingPageHelper.clickPriceButton'()

assert result == true

String Product = CustomKeywords.'onlineshop.Keywords.ProductListingPageHelper.getProductNumberButtonText'()

boolean result2 = CustomKeywords.'onlineshop.Keywords.ProductListingPageHelper.clickMinPriceTextBox'()
...
boolean result3 = CustomKeywords.'onlineshop.Keywords.ProductListingPageHelper.clickBrandDeleteButton'()
