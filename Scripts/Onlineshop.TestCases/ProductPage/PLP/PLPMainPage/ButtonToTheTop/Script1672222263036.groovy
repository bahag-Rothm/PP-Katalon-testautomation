...
boolean ToTheTop = CustomKeywords.'onlineshop.Keywords.ProductListingPageHelper.toTheTopIcon'()

assert ToTheTop == true

CustomKeywords.'onlineshop.Keywords.ProductListingPageHelper.setViewPortsizeToMobile'()

boolean ToTheTop2 = CustomKeywords.'onlineshop.Keywords.ProductListingPageHelper.toTheTopIcon'()

assert ToTheTop2 == false
