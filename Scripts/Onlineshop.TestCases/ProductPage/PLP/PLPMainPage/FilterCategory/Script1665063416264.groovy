...
boolean resultCategory = CustomKeywords.'onlineshop.Keywords.ProductListingPageHelper.clickCategoryButton'()
...
boolean resultSubcategory = CustomKeywords.'onlineshop.Keywords.ProductListingPageHelper.clickSubcategoryButton'()

assert resultSubcategory == true
...
boolean resultBackToGarden = CustomKeywords.'onlineshop.Keywords.ProductListingPageHelper.clickBacktoGardenButton'()

assert resultBackToGarden == true
