...
boolean NL = CustomKeywords.'onlineshop.Keywords.HomePageHelper.closeNLPopup'()
assert NL == true

boolean result = CustomKeywords.'onlineshop.Keywords.ProductTileHelper.checkComparisonIcon'()

assert result == true

CustomKeywords.'onlineshop.Keywords.ProductListingPageHelper.setViewPortsizeToMobile'()
boolean result2 = CustomKeywords.'onlineshop.Keywords.ProductTileHelper.checkComparisonIcon'()
