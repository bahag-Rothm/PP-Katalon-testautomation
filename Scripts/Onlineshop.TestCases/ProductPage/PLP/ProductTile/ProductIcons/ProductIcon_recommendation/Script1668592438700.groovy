...
boolean result = CustomKeywords.'onlineshop.Keywords.ProductTileHelper.checkRecommendationIcon'()

assert result == true

CustomKeywords.'onlineshop.Keywords.ProductListingPageHelper.setViewPortsizeToMobile'()

boolean result2 = CustomKeywords.'onlineshop.Keywords.ProductTileHelper.checkRecommendationIcon'()
