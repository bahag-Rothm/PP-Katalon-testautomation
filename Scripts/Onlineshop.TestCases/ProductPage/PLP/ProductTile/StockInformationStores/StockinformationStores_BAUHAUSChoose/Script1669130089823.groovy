...
boolean result = CustomKeywords.'onlineshop.Keywords.ProductTileHelper.checkBAUHAUSChoose'()

assert result == true

CustomKeywords.'onlineshop.Keywords.ProductListingPageHelper.setViewPortsizeToMobile'()

boolean result2 = CustomKeywords.'onlineshop.Keywords.ProductTileHelper.checkBAUHAUSChoose'()
