...
CustomKeywords.'onlineshop.Keywords.HomePageHelper.chooseBAUHAUS'(shopname)

boolean result = CustomKeywords.'onlineshop.Keywords.ProductTileHelper.checkReseravable'()

assert result == true

CustomKeywords.'onlineshop.Keywords.ProductListingPageHelper.setViewPortsizeToMobile'()

boolean result2 = CustomKeywords.'onlineshop.Keywords.ProductTileHelper.checkReseravable'()
