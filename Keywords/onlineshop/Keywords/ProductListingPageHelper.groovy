...
public class ProductListingPageHelper {
	...
	def checkButtons() {
		int num = 0
		int countButtons = 4
		boolean categoryButton = checkCategoryButton();
		boolean materialButton = checkMaterialButton();
		boolean offersButton = checkOffersButton();
		boolean brandButton = checkBrandButton();
		boolean priceButton = checkPriceButton();
		boolean producttypButton = checkProductTypButton();
		boolean filterandsortButton = checkFilterAndSortButton();
		if(categoryButton) {
			num++
		}
		if(materialButton) {
		...
		if(filterandsortButton) {
			num++
		}

		//if 4 ore more buttons are visible = True otherwise False
		if(num >= countButtons ) {
	...
	//checks if the filterbar brand button is visible
	@Keyword
	def clickFilterBarBrandButton() {


		String brandButton = WebUI.waitForElementVisible(findTestObject('Onlineshop.Pages/ProduktePage/Elements/PLP/FilterSideBar/SideBarBrandButton'), 5)
		KeywordUtil.logInfo("Filterbar brand button is visible: "+ brandButton);

		if(brandButton == "true") {
			String brandButton2 = WebUI.click(findTestObject('Onlineshop.Pages/ProduktePage/Elements/PLP/FilterSideBar/SideBarBrandButton'))
			KeywordUtil.logInfo("Filterbar brand button exist");
			return true
		}
		else {
			KeywordUtil.logInfo("Filterbar brand button not exist");
			return false
		}
	}
	...
	def toTheTopIcon() {
		...
		//Insert Object
		String toTheTop = WebUI.waitForElementVisible(findTestObject('Onlineshop.Pages/ProduktePage/Elements/PLP/SidebarIcons/ToTheTop'),3, FailureHandling.OPTIONAL)
		String toTheTopIconWidth = WebUI.getElementWidth(findTestObject('Onlineshop.Pages/ProduktePage/Elements/PLP/SidebarIcons/ToTheTop'), FailureHandling.OPTIONAL)
		String toTheTopIconHeight = WebUI.getElementHeight(findTestObject('Onlineshop.Pages/ProduktePage/Elements/PLP/SidebarIcons/ToTheTop'), FailureHandling.OPTIONAL)
	...
	def closeSideBar() {
		...
		if(closeSidebar == "true") {
			...
			KeywordUtil.logInfo("Closed sidebar");
			return true
		}
		else {
			KeywordUtil.logInfo("Sidebar cannot be closed");
			return false
		}
	}
	...
	//checks if the sort name desc button is visible
	@Keyword
	def checkSortingNameDescButton() {

		String SortingNameDescButton = WebUI.waitForElementVisible(findTestObject('Onlineshop.Pages/ProduktePage/Elements/PLP/FilterSideBar/SortingFilter/SortingNameDesc'), 5)
		KeywordUtil.logInfo("Sorting name DESC button button is visible: "+ SortingNameDescButton);

		if( SortingNameDescButton == "true") {
			KeywordUtil.logInfo("Sorting name DESC button exist");
			return true
		}
		else {
			KeywordUtil.logInfo("Sorting name DESC button not exist");
			return false
		}
	}
	...
	def checkPriceDescButton() {
		...
		if(PriceDESC == "true") {
			KeywordUtil.logInfo("Sorting price DESC button exist");
			return true
		}
		else {
			KeywordUtil.logInfo("Sorting price DESC button not exist");
			return false
		}
	}
